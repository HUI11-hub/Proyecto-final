...
return function (App $app) {
    ...
    $app->group('/operations', function (RouteCollectorProxy $group) {
        ...
        $group->post('', [OperationCommandController::class, 'post'])->setName('api_operations_post');
        ...
        $group->group('/{operacionId}', function (RouteCollectorProxy $group) {
            ...
            $group->put('', [OperationCommandController::class, 'put'])->setName('api_operations_put');
            $group->delete('', [OperationCommandController::class, 'delete'])->setName('api_operations_delete');
